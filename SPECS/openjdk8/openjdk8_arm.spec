...
%define _repo_ver aarch32-jdk8u%{_jdk_update}-b%{_jdk_build}
...
Release:	1%{?dist}
License:	GNU GPL
URL:		http://hg.openjdk.java.net/aarch32-port/jdk8u/
...
%prep -p exit
%setup -qn openjdk-aarch32-jdk8u-%{_repo_ver}
%patch0 -p1
%patch1 -p1
...
find /usr/local/jvm/openjdk-1.8.0-internal/jre/lib/aarch32 -iname \*.diz -delete
...
%{_libdir}/jvm/OpenJDK-%{version}/lib/aarch32/jli/
%exclude %{_libdir}/jvm/OpenJDK-%{version}/lib/aarch32/*.diz
